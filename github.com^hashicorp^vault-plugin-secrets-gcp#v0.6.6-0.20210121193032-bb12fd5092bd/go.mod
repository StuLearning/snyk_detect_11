module github.com/hashicorp/vault-plugin-secrets-gcp-v0.6.6-0.20210121193032-bb12fd5092bd

go 1.17

require github.com/hashicorp/vault-plugin-secrets-gcp v0.6.6-0.20210121193032-bb12fd5092bd
